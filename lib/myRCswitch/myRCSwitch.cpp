/*
  myRCSwitch - Arduino libary for remote control outlet switches
...
/**
  ...
  */
void myRCSwitch::setProtocol(int nProtocol, int nPulseLength) {
  this->nProtocol = nProtocol;
 ...
 */
/* void myRCSwitch::switchOn(char sGroup, int nDevice) {
 ...
 * @param nDevice       Number of the switch itself (1..3)
 */
/* void myRCSwitch::switchOff(char sGroup, int nDevice) {
 ...
 * @param nDevice  Number of device (1..4)
  */
/* void myRCSwitch::switchOn(char sFamily, int nGroup, int nDevice) {
 ...
 * @param nDevice  Number of device (1..4)
 */
/* void myRCSwitch::switchOff(char sFamily, int nGroup, int nDevice) {
 ...
 */
/* void myRCSwitch::switchOn(int nAddressCode, int nChannelCode) {
 ...
 * @param nChannelCode  Number of the switch itself (1..4)
 */
/* void myRCSwitch::switchOff(int nAddressCode, int nChannelCode) {
 ...
 */
/* void myRCSwitch::switchOn(char* sGroup, int nChannel) {
 ...
 * @param nChannelCode  Number of the switch itself (1..5)
 */
/* void myRCSwitch::switchOff(char* sGroup, int nChannel) {
  char* code[6] = { "00000", "10000", "01000", "00100", "00010", "00001" };
 ...
 */
/* void myRCSwitch::switchOn(char* sGroup, char* sDevice) {
 ...
 * @param sDevice       Code of the switch device (refers to DIP switches 6..10 (A..E) where "1" = on and "0" = off, if all DIP switches are on it's "11111")
 */
/* void myRCSwitch::switchOff(char* sGroup, char* sDevice) {
 ...
 * @return char[13]
 */
char* myRCSwitch::getCodeWordB(int nAddressCode, int nChannelCode, boolean bStatus) {
   int nReturnPos = 0;
 ...
 *
 */
char* myRCSwitch::getCodeWordA(char* sGroup, char* sDevice, boolean bOn) {
 ...
 */
char* myRCSwitch::getCodeWordC(char sFamily, int nGroup, int nDevice, boolean bStatus) {
  static char sReturn[13];
  int nReturnPos = 0;
...
char* myRCSwitch::getCodeWordD(char sGroup, int nDevice, boolean bStatus){
    static char sReturn[13];
    int nReturnPos = 0;
 ...
 */
void myRCSwitch::sendTriState(char* sCodeWord) {
